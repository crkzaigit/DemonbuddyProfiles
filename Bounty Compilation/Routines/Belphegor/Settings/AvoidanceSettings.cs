...
namespace Belphegor.Settings
{
    ...
    public class AvoidanceSettings : XmlSettings
    {
        ...
        [XmlElement("IsBloodSpringDodgeActive")]
        [DisplayName("Activate BloodSpring dodgeing")]
        [Description("Should BloodSpring ground effects be dodged.")]
        [DefaultValue(true)]
        [Setting]
        [Category("BloodSpring")]
        public bool IsBloodSpringDodgeActive { get; set; }

        [XmlElement("BloodSpringDodgeRadius")]
        [DisplayName("BloodSpringdodge radius")]
        [Description("Range for BloodSpring avoidance.")]
        [DefaultValue(9)]
        [Setting]
        [Category("BloodSpring")]
        [Limit(1, 40)]
        public float BloodSpringDodgeRadius { get; set; }

        [XmlElement("BloodSpringDodgeHealthPct")]
        [DisplayName("BloodSpring dodge health %")]
        [Description("Maximum health % to trigger BloodSpring avoidance.")]
        [DefaultValue(1)]
        [Setting]
        [Category("BloodSpring")]
        [Limit(0, 1)]
        public float BloodSpringDodgeHealthPct { get; set; }
