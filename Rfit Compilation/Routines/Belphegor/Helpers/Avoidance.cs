    ...
    internal static class Avoidance
    {
                        ...
                        new PrioritySelector(
                            ...
                            new Decorator(
                                ctx =>
                                    ...
                                    ((CombatContext) ctx).TargetPosition != Vector3.Zero && !_wasStuck,
                            ...
                            new Decorator(
                                ...
                                {
                                    if (BelphegorSettings.Instance.Debug.IsDebugAvoidanceLog)
                                        Log.Info("Avoidance waiting for target in range.");
        ...
        internal static float GetCollisionRadius(this DiaObject obj)
        {
            switch (obj.ActorSNO)
            {
                ...
                case (int) GroundEffectSNOs.BloodSpring:
                case (int) GroundEffectSNOs.BloodSpringMed:
                case (int) GroundEffectSNOs.BloodSpringSmall:
                    return BelphegorSettings.Instance.Avoidance.BloodSpringDodgeRadius;
        ...
        internal static bool IsAoe(this DiaObject obj)
        {
            switch (obj.ActorSNO)
            {
                ...
                case (int) GroundEffectSNOs.BloodSpringMed:
                case (int) GroundEffectSNOs.BloodSpringSmall:
                    return BelphegorSettings.Instance.Avoidance.IsBloodSpringDodgeActive;
                case (int) GroundEffectSNOs.Desecrator:
        ...
        internal static float GetTriggerHealthPct(this DiaObject obj)
        {
            switch (obj.ActorSNO)
            {
                ...
                case (int) GroundEffectSNOs.BloodSpringMed:
                case (int) GroundEffectSNOs.BloodSpringSmall:
                    return BelphegorSettings.Instance.Avoidance.BloodSpringDodgeHealthPct;
                case (int) GroundEffectSNOs.Desecrator:
        ...
        {
            BloodSpring = 332922,
            BloodSpringSmall = 332924,
            BloodSpringMed = 332923,
